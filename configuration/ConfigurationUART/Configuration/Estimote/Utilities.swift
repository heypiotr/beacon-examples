...
func operationForSetting(
    ...
    -> ESTBeaconOperationProtocol! {
        ...
        case let setting as ESTSettingGPIOConfigPort0:
            return ESTBeaconOperationGPIOConfigPort0.writeOperationWithSetting(setting,
                completion: completionGenerator(operationIdentifier: "GPIO port 0 mode"))

        case let setting as ESTSettingGPIOConfigPort1:
            return ESTBeaconOperationGPIOConfigPort1.writeOperationWithSetting(setting,
                completion: completionGenerator(operationIdentifier: "GPIO port 1 mode"))
